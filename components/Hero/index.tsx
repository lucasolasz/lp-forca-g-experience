        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <h1 className="text-[15vw] md:text-[12vw] font-display uppercase leading-[0.85] mb-8 tracking-tighter">
              DOMINE <br /> A
              <span className="text-brand-accent">GRAVIDADE</span>
            </h1>
            <p className="max-w-2xl mx-auto text-lg md:text-xl text-white/70 font-light mb-10">
              Voo acrobático real com o líder da Esquadrilha da Fumaça.
              Loopings, tunôs e a chance de assumir o manche sobre o litoral
              carioca.
            </p>
            <div className="relative flex flex-col md:flex-row items-center justify-center gap-4 mt-4">
              ...
              <a
                ...
                className="w-full md:w-auto bg-brand-accent text-white px-10 py-5 rounded-full font-bold text-lg hover:scale-105 transition-transform flex items-center justify-center gap-2"
              >

...
export const FAQ = [
  {
    ...
    answer: "Um voo acrobático de 20 minutos com o piloto Alfredo Leta, cheio de adrenalina, sobre a Barra da Tijuca e Recreio, decolando do Clube da Aeronáutica."
  },
  {
    question: "Posso pilotar o avião?",
    answer: "Sim, você pode assumir o manche por alguns instantes, com supervisão do piloto."
  },
  {
    question: "O voo é seguro?",
    answer: "Sim, o piloto Tenente-Coronel Salvatore tem mais de 3.000 horas de voo, e o avião RV-7A é projetado especificamente para acrobacias, seguindo rigorosos protocolos de segurança."
  },
  {
    question: "Vou enjoar no voo?",
    answer: "Se você tende a enjoar, informe antes. Podemos adaptar as manobras para seu total conforto."
  },
  {
    question: "Como funciona o agendamento?",
    answer: "Combinamos um dia e horário com pelo menos 10 dias de antecedência via WhatsApp. O pagamento é feito após o voo."
  }
];
